...
module.exports = function (options) {
  ...
  return {
    ...
    resolve: {
       ...
       */
      modules: [helpers.root('src'), helpers.root('node_modules'), helpers.root('src/app')],
      alias: {
          //'components$': helpers.root('src/app/components/index.ts'),
          //'services$': helpers.root('src/app/services/index.ts'),
          //'models$': helpers.root('src/app/models/index.ts'),
          //'pipes$': helpers.root('src/app/pipes/index.ts'),
          //'directives$': helpers.root('src/app/directives/index.ts'),
          //'extentions$': helpers.root('src/app/extentions.ts'),
      }
    },
